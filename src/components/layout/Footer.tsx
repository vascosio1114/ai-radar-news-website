...
import { getLangNavItems, SITE_EMAIL, SITE_NAME, SUPPORTED_LANGS } from "@/lib/site";
...
export function Footer() {
  ...
  const navItems = [
    ...
    { href: `/${lang}/about`, label: lang === "zh" ? "關於" : "About" },
      ...
      <div className="container-page grid gap-12 py-16 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-md text-sm leading-relaxed text-ink-500 dark:text-ink-400">
            {lang === "zh"
              ? "AI 文章、工具整理、教學與趨勢分析，幫你持續追蹤人工智能浪潮。"
          ...
          <div className="mt-6 flex items-center gap-2">
            ...
            <SocialIcon href={`mailto:${SITE_EMAIL}`} label="Email" icon={<Mail className="h-4 w-4" />} />
          </div>
        </div>

        <div>
          <h4 className="text-xs font-semibold uppercase tracking-widest text-ink-500 dark:text-ink-400">
            {lang === "zh" ? "網站導覽" : "Navigation"}
          </h4>
